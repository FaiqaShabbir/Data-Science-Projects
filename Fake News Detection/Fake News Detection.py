...
df = pd.read_csv('C:/Users/faiqa/Downloads/Flask/news.csv')
df.shape
# print(df)
# print(df.head())
labels = df.label
...
# So with this model, we have 594 true positives, 586 true negatives,
# 44 false positives, and 43 false negatives.
